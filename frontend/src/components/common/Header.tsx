      ...
      <div className="flex items-center lg:order-2">
        ...
        <div
            ...
            >
              ...
              <div className="pl-3 w-full">
                <div className="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                  ...
                  <span className="font-semibold text-gray-900 dark:text-white"> Akila Kavinda</span>: "Issue with logging in."
                </div>
          ...
          <a href="#"
            ...
            <div className="inline-flex items-center">
              <svg aria-hidden="true" className="mr-2 w-4 h-4 text-gray-500 dark:text-gray-400" fill="currentColor"
        ...
        <div
          ...
          <div className="py-3 px-4">
            <span className="block text-sm font-semibold text-gray-900 dark:text-white">Charith Dilanka</span>
            <span className="block text-sm text-gray-900 truncate dark:text-white">charith@iphonik.com</span>
          </div>
    ...
    <div className="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
      ...
      <ul className="space-y-2">
        ...
        <li>
          ...
          <span className="flex-1 ml-3 text-left whitespace-nowrap">Tickets</span>
          </Link>
        </li>
        <li>
          <Link to="/contacts"
            ...
            <span className="flex-1 ml-3 text-left whitespace-nowrap">Contacts</span>
          </Link>
        </li>
        <li>
          <Link to="/companies"
